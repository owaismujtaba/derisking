...
**Results**: Aggregate Trade Dependency Index (TDI) on China increased from 15.47% (baseline: 2007-2019) to 21.86% (intervention: 2020-2024), a statistically significant increase (t=-5.518, p<0.0001, Cohen's d=3.385). However, COVID-19 disentanglement reveals context-dependent effectiveness: pandemic-sensitive goods account for 48% of the TDI increase (+3.09 of +6.39 percentage points). Critically, when excluding pandemic goods, the dependency growth trend **decelerated** from +0.31%/year (pre-2020) to +0.22%/year (post-2020), a 28% slowdown (Chow test: F=1.87, p=0.18, non-significant structural break). Non-pandemic sectors showed major improvements: chemicals -68%, steel -57%, plastics -58%. Pandemic-sensitive sectors worsened: pharmaceuticals +68%, electronics +25%, medical instruments +50%.

**Conclusions**: India's derisking initiative shows **context-dependent effectiveness** rather than uniform failure. The policy is slowing dependency growth in non-pandemic sectors (chemicals, steel, plastics) where technology gaps are small and cost differentials moderate. However, COVID-19 demand spikes overwhelmed policy effects in pandemic-sensitive sectors (electronics, pharmaceuticals, medical equipment) where China's manufacturing resilience and technological dominance created unavoidable sourcing. Our findings demonstrate that (1) external shocks can mask policy effects, requiring methodological disentanglement; (2) policy effectiveness varies systematically by sector characteristics; (3) short-term evaluation (4 years) may be premature for industrial policies with 10-15 year gestation periods. These insights have implications for global derisking efforts and economic statecraft theory.
